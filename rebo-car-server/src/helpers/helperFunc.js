...
const deleteImageOfDiscount = (discount) => {
    const discountImagePath = discount.image.replace("static", "public");
    deleteFileWithPath(discountImagePath);
};
