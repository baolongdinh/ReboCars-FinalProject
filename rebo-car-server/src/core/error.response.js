...
class BadRequestError extends ErrorResponse {
  constructor(
    message = httpStatusCodes.ReasonPhrases.BAD_REQUEST,
...
class ForbiddenError extends ErrorResponse {
  constructor(
    message = httpStatusCodes.ReasonPhrases.FORBIDDEN,
...
class NotfoundError extends ErrorResponse {
  constructor(
    message = httpStatusCodes.ReasonPhrases.NOT_FOUND,
...
class InternalServerError extends ErrorResponse {
  constructor(
    message = httpStatusCodes.ReasonPhrases.INTERNAL_SERVER_ERROR,
