<template>
    <b-modal class="" v-model="showAddRoleModal" title="Role Detail" hide-footer hide-header :scrollable="true">
...
export default {
    ...
    methods: {
        ...
        ConfirmUpdated() {
            ...
            rolesRepo.addRole(payload).then((result) => {
                console.log({ result })
                this.closeModal()
                this.$notify({
                    title: 'Notification',
                    text: 'add new role success.',
                    type: 'success'
                });
